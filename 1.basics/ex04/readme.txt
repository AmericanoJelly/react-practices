...
1. webpack은 작게 분리된 많은 애플리케이션의 모듈 (js, css, images, font)들의 '의존성 분석' 하여 하나의 JS파일로 묶는 도구

2. 최종 결과물인 하나의 JS파일 번들(bundel)이라고 부른고 묶는 작업을 번들링(bundel)이라 한다.
...
5. JS 모듈 뿐만 아니라 다앙햔 asset(images, css, sass/scss, font)들도 모듈로 취급한다.
