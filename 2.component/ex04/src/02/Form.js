...
export default function Form() {
    ...
    const [description, setDescription] = useState("안녕");
    ...
    return (
        <form id="joinForm" name="joinForm" method="post" action="/do/not/post">
            ...
            <input 
                ...
                null:
                validEmail 
                ? <FontAwesomeIcon icon={faCheckCircle} style={{marginLeft:5, fontSize:15, color:"blue"}}/> 
            ...
            <input  id="password" 
                    ...
                    type="password" 
                    value={password} 
                    onChange={e => setPassword(e.target.ATTRIBUTE_NODE.value)} />
